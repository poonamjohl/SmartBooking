...
<main class="wrapper">
	...
	<div class="search-tours g-heading-v8" id="Hotel-Detail">
		<div class="container">
			<div class="row">
					<c:if test="${empty hotel}">
						<h2>No Hotel found. Please try after sometime</h2>
					</c:if>
					<c:if test="${not empty hotel}">
						<div class="col-md-12 search-tours-col-bg-default">
						<div class="row">
							<div class="col-xs-12">
								<div class="our-tours-list-item col-xs-12" id="${hotel.hotelId}">
									<div class="img-wrapper img-wrapper--shadow text-center">
										<img src="${hotel.image}" alt="ALT" class="img-reponsive" style="max-width: 1000px;">
									</div>
									...
									<ul class="list-inline star-vote">
										...
										<c:if test="${hotel.ratings == '3.0'}">
											<li><i class="g-color-default fa fa-star-o"></i></li>
											<li><i class="g-color-default fa fa-star-o"></i></li>
										</c:if>
										<c:if test="${hotel.ratings == '3.5'}">
											<li><i class="g-color-default fa fa-star-half-o"></i></li>
											<li><i class="g-color-default fa fa-star-o"></i></li>
										</c:if>
		
										<c:if test="${hotel.ratings == '4.0'}">
											<li><i class="g-color-default fa fa-star"></i></li>
											<li><i class="g-color-default fa fa-star-o"></i></li>
										</c:if>
										<c:if test="${hotel.ratings == '4.5'}">
											<li><i class="g-color-default fa fa-star"></i></li>
											<li><i class="g-color-default fa fa-star-half-o"></i></li>
										</c:if>
										<c:if test="${hotel.ratings == '5.0'}">
											<li><i class="g-color-default fa fa-star"></i></li>
											<li><i class="g-color-default fa fa-star"></i></li>
										</c:if>
									</ul>
									<label>Room Type:</label><p>${hotel.roomType}</p>
									<label>Breakfast Offered:</label><p>${hotel.breakfast}</p>
									<label>Beds:</label><p>${hotel.beds}</p>
									<label>Bed Type:</label><p>${hotel.bedType}</p>
									<label>Max Occupants:</label><p>${hotel.maxPerson}</p>
									<label>Available:</label><p>${hotel.available}</p>
									<label>Amenities:</label><p>${hotel.amenities}</p>
									<div class="our-tours-price col-xs-10">
										<p>$${hotel.price}.00</p>
										<div class="row">
											<div class="col-xs-6">
												<a href="#" class="btn btn-warning">View Review</a>
												<c:if test = "${sessionScope.userid!=null}">
													<a href="#" class="btn btn-warning">Write Review</a>
												</c:if>
											</div>
											<c:if test = "${sessionScope.userid!=null}">
