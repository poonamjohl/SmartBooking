...
protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
{
	...
	Utilities utility = new Utilities(request,out);	
		...
		out.println("Added hotel successfully");
...
public void managedata(HttpServletRequest request)
{
		...
		try{
			System.out.println("new product entry reached");
			Connection conn=sdu.getConnection();
				
				
				
				PreparedStatement ps=conn.prepareStatement("insert into Hotels(country, city,hotelName, rating,nearBy,roomType,breakfast,size,price,available,sold,beds,bedType,maxOccupants,amenities,images) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			...
			{
					System.out.println("error while adding hotels"+e);
