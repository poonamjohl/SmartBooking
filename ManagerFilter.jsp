...
<<<<<<< HEAD
					<form action="ManagerFilter" class="sky-form clearfix" name="filterForm">
=======
					<form action="FilterServlet" class="sky-form clearfix" name="filterForm">
>>>>>>> 0b0e10a4c5ea1be6e2eb50493e833204e24c591b
						<!-- <div class="container"> -->
										...
										<div class="our-tours-price col-xs-10">
											...
											<div class="row">
												...
												<form action="DeleteServlet">
													...
													<input type='hidden' name="cType" id='cType' value='hotel'/>
													<input type='hidden' name="chotelId" id='chotelId' value='${entry.key}'/>
													<div class="col-xs-3 text-right">
														<button type='submit' class='btn btn-primary save-order' onclick="return verify();">Delete</button>
													</div>
												</form>
												<form action="UpdateServlet">
													...
													<input type='hidden' name="chotelId" id='chotelId' value='${entry.key}'/>
													<div class="col-xs-3 text-right">
														<button type='submit' class='btn btn-primary save-order' onclick="return verify();">Update</button>
													</div>
												</form>
											</div>
										</div>
