						...
						<div class="row">
							<c:forEach var="item" items="${wishlist.items}">
								...
								<form action="CartServlet">
									<input type='hidden' name="chotelId" id='chotelId' value='${item.id}'/>
									<input type='hidden' name="wishToCart" id='chotelId' value='true'/>
									<div class="col-xs-3 text-right">
										<button type='submit' class='btn btn-primary save-order'>Add to Cart</button>
									</div>
								</form>
							</c:forEach>
						</div>
